...
![Example protein structure rendered from PDB entry 9R1O using Molfig with the Mol* representation](package/examples/9R1O.png)
...
Bundled example structure files under [`package/examples/data`](package/examples/data) are PDB archive data from RCSB PDB / wwPDB and are available under CC0 1.0. Per-file PDB IDs, DOIs, and recommended attributions are listed in [`package/examples/data/README.md`](package/examples/data/README.md).

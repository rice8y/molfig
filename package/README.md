...
![Ethanol rendered from a PubChem3D XYZ conformer](examples/ethanol-xyz.png)
...
![RCSB PDB entry 1CRN rendered with Illustrative style](examples/illustrative-1crn.png)
...
The full manual is [`docs/documentation.pdf`](docs/documentation.pdf), with source in [`docs/documentation.typ`](docs/documentation.typ). Complete sources and rendered results are under [`examples`](examples); data attribution is in [`examples/data/README.md`](examples/data/README.md).
